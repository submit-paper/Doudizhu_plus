...
parser.add_argument('--coach_length', default=4, type=int,
                    help='The size for a batch by one agent')
...
parser.add_argument('--coach_thresh', default=0, type=float,
                    help='The threshold value for the coach network')
# Optimizer settings
